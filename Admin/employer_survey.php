        ...
        <div class="navbox">
            ...
            <div class="navpanel">
                ...
                <div class="item">
                    ...
                    <ul>
                    <li><a style="padding-top:20px; padding-bottom:20px;" href="Allsurveys"><i class="fa fa-pen"></i> Surveys & Summary</a></li>
         ...
         <?php 
           ...
           <CAPTION><h3>Employers Surveys</h3></CAPTION>
            ...
            <a href='emp_add_survey' class='print_grad' style=''><i class='fa fa-plus'></i> Add Survey</a>
                ...
                //***************************Showing all Surveys  */ 
                        ...
                        $query = mysqli_query($conn, "SELECT * FROM mysurveytbl WHERE user_ID = $db_id AND Survey_ID !='35' ");
                        ...
                        $sql = "SELECT Survey_ID, Title, Description, Date_created, End_date, Status, Respondents FROM mysurveytbl WHERE user_ID = $db_id AND Survey_ID !='35' AND Survey_type = 'employer' ORDER BY Survey_ID DESC limit $start_from,$num_per_page";
                ...
                //******************************SHOWING Survey TABLE <img src='../img/responsewhite.png'> <img  src='../img/questionwhite.png'>  <img src='../img/Addreswhite.png'> <img src='../img/delete1.png'>*/
                            ...
                            echo "<tbody><tr height='30'>
                                   ...
                                   <a class='toole' href='emp_edit_survey?jScript=$jScript && newScript=$newScript && getEdit=$getEdit && SID=$surveyID && ID=$db_id' >
